...
document.addEventListener('DOMContentLoaded', function() {
    ...
    contactForm.addEventListener('submit', function(e) {
        ...
        .then(data => {
            ...
            feedbackEl.className = data.success ? 'form-feedback success' : 'form-feedback error';
            feedbackEl.textContent = data.message;
            
            // Adicionar mensagem ao formulário
            contactForm.prepend(feedbackEl);
        ...
        .catch(error => {
            ...
            feedbackEl.textContent = 'Ocorreu um erro ao enviar sua mensagem. Por favor, tente novamente.';
